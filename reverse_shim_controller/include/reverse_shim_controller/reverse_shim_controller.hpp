...
#ifndef REVERSE_SHIM_CONTROLLER__REVERSE_SHIM_CONTROLLER_HPP_
#define REVERSE_SHIM_CONTROLLER__REVERSE_SHIM_CONTROLLER_HPP_
...
/**
 * @class reverse_shim_controller::ReverseShimController
 * @brief Rotate to rough path heading controller shim plugin
 */
class ReverseShimController : public nav2_core::Controller
{
public:
  /**
   * @brief Constructor for reverse_shim_controller::ReverseShimController
   */
  ReverseShimController();

  /**
   * @brief Destrructor for reverse_shim_controller::ReverseShimController
   */
  ~ReverseShimController() override = default;
...
protected:
  ...
  rclcpp::Logger logger_ {rclcpp::get_logger("ReverseShimController")};
...
#endif  // REVERSE_SHIM_CONTROLLER__REVERSE_SHIM_CONTROLLER_HPP_
